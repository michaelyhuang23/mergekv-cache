...
from src.hf_cache import KNormCache, TopKKV, MergeKV, CentroidKV, MeanKV, HybridKV
from lm_eval import evaluator
from lm_eval.models.huggingface import HFLM
from lm_eval.utils import make_table
from datasets import load_dataset
from lm_eval.tasks import get_task_dict
from src.attn_patch import patched_centroidkv_qwen2_attn_forward, patched_mergekv_qwen2_attn_forward
from transformers.models.qwen2.modeling_qwen2 import Qwen2Attention

Qwen2Attention.forward = patched_mergekv_qwen2_attn_forward
...
def patched_generate(*args, **kwargs):
    #model._active_cache = CentroidKV(compression_ratio=0.5, window_ratio=0.0256, top_k_ratio=0.0256)
    #model._active_cache = MergeKV(compression_ratio=0.8, window_ratio=0.0256, top_k_ratio=0.0256)
    model._active_cache = HybridKV(compression_ratio=0.8, window_ratio=0.0256, top_k_ratio=0.0256)
    #model._active_cache = MeanKV(compression_ratio=0.8, window_ratio=0.0256, top_k_ratio=0.0256)
