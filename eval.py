...
from src.hf_cache import KNormCache, TopKKV, MergeKV, CentroidKV
...
Qwen2Attention.forward = patched_centroidkv_qwen2_attn_forward
...
def patched_generate(*args, **kwargs):
    model._active_cache = CentroidKV(compression_ratio=0.8, window_ratio=0.0256, top_k_ratio=0.0256)
